...
> ✅ **Status: working product v2.9.3.** A 9-page dashboard (Overview, Traffic, Behavior, Funnel,
...
| ------------------------------------------------------------------------------------ | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.9.3** (Latest)                                                                  | 2026-05-29 | Overview Gap reconciled with Goals/report (counts purchase payments), empty sections dropped from DOCX/PDF, AI narrative HTML-tags stripped; verified against Yandex Metrika             |
