...
> демо-данные), дашборд из 9 страниц (Обзор, Трафик, Поведение, Воронка, Цели, Отчёт, История,
> Настройки, Справка), мобильное меню (гамбургер), AI-анализ в 5 секций с прогресс-баром,
> синхронизация с детальным прогрессом, детальные аналитические выводы на каждой странице,
> кастомный date picker, детерминированные DOCX/PDF с русскими терминами, развёртывание одной
> командой, полный CI/CD. 397 тестов проходят. Проверено на живых данных счётчика ProductCamp
> (54280963).
