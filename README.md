...
> ✅ **Статус: рабочий продукт v2.9.3.** Дашборд из 9 страниц (Обзор, Трафик, Поведение,
...
| -------------------------------------------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v2.9.3** (Latest)                                                                    | 2026-05-29 | Согласование Gap на «Обзоре» с «Целями»/отчётом (учёт оплат-покупки), удаление пустых разделов из DOCX/PDF, очистка AI-нарратива от HTML-тегов; сверено с Яндекс.Метрикой                               |
