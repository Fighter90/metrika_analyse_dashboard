...
## 3. Dashboard pages *(Iterations 4–7)*
...
## 4. Working with hypotheses *(Iteration 6)*
...
## 6. Generating reports *(Iterations 8–10)*
...
Via CLI without UI *(Iterations 9–10)*:
