...
- **ADR-008** — server-side рендер графиков в DOCX/PDF (§6.4): зафиксирован подход
  (Puppeteer + ECharts, PNG в снапшоте, без новой зависимости) и инвариант DOCX==PDF.
  Реализация — отдельной итерацией (см. `docs/decisions/008-server-side-report-charts.md`).
